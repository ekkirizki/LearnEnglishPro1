...
public class ListQuiz extends AppCompatActivity {
    ...
    private DocumentReference PCT, SPasT, SPreT, SPerT, Past1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.list_view1);
            ...
            Past = db.collection("Soal").document("1").collection("Past Tense");
        Past1 = db.collection("Soal").document("1");
        ...
        Past.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                arrayAdapter = new ArrayAdapter<String>(ListQuiz.this, android.R.layout.simple_list_item_1, ids);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ListQuiz.this,yourData,Toast.LENGTH_LONG).show();
                Intent i = new Intent(ListQuiz.this, Youtube.class);
